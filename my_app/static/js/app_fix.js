...
ansdiv = document.querySelector('.correctProcess'),
cropper = '';
...
dwn.addEventListener('click', e => {
  ...
  //window.location.href='landingpage?imgurl='+yobro+'&answer='+ans.value;
      ...
      // hidden form to send data and display new webpage from server
      // as POST; rather than GETimage data in long url, this sends
      // the data as post after the url. form handles encoding.
      // https://postman-echo.com/post is useful for debugging

      document.getElementById("imgurl").value=url;
      document.getElementById("outanswer").value=ans.value;
      landingpage.submit();
